# AGENTS.md — Project Map (Example)

> This is the AGENTS.md that would exist for the JHA Safety Forms project.
...
| File | Status | Description |
|------|--------|-------------|
| design/components.md | ⬜ template | Component catalog |
| design/flows.md | ⬜ template | User flows |
| design/prototype/ | ⬜ empty | UI specs |
